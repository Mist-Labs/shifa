...
DANGER_SIGN_SYNONYMS: dict[str, list[str]] = {
    ...
    "lethargic or unconscious": ["lethargic", "lethargy", "unconscious", "unresponsive", "altered consciousness", "very sleepy"],
    "unable to drink": ["inability to drink", "cannot drink", "not able to drink", "refuses fluids", "unable to take fluids"],
