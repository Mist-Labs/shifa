...
MODEL_ARTIFACTS = [
    ...
    ("reports/e2b_validation_metrics.json", "reports/e2b_validation_metrics.json"),
    ("reports/e2b_training_manifest.json", "reports/e2b_training_manifest.json"),
    ...
    ("models/shifa-gemma4-e2b-finetuned/chat_template.jinja", "models/shifa-gemma4-e2b-finetuned/chat_template.jinja"),
    ("models/shifa-gemma4-e2b-finetuned/README.md", "models/shifa-gemma4-e2b-finetuned/README.md"),
    ("models/shifa-gemma4-e2b-finetuned/processor_config.json", "models/shifa-gemma4-e2b-finetuned/processor_config.json"),
    ("models/shifa-gemma4-e2b-finetuned/adapter_model.safetensors", "models/shifa-gemma4-e2b-finetuned/adapter_model.safetensors"),
    ("models/shifa-gemma4-e2b-finetuned/adapter_config.json", "models/shifa-gemma4-e2b-finetuned/adapter_config.json"),
    ("models/shifa-gemma4-e2b-finetuned/tokenizer_config.json", "models/shifa-gemma4-e2b-finetuned/tokenizer_config.json"),
    ("models/shifa-gemma4-e2b-finetuned/tokenizer.json", "models/shifa-gemma4-e2b-finetuned/tokenizer.json"),
    ("models/shifa-gemma4-e2b-finetuned/shifa-gemma4-e2b-finetuned.litertlm", "models/shifa-gemma4-e2b-finetuned/shifa-gemma4-e2b-finetuned.litertlm"),
    ("models/shifa-gemma4-e2b-finetuned/shifa-gemma4-e2b-finetuned.task", "models/shifa-gemma4-e2b-finetuned/shifa-gemma4-e2b-finetuned.task"),
    ("models/shifa-gemma4-e2b-finetuned/shifa-gemma4-e2b-finetuned.tflite", "models/shifa-gemma4-e2b-finetuned/shifa-gemma4-e2b-finetuned.tflite"),
    ("models/gguf/shifa-gemma4-e2b-q4km.gguf", "models/shifa-gemma4-e2b-finetuned/shifa-gemma4-e2b-q4km.gguf"),
